...
`src/main/resources/META-INF/native-image/` and is generated by GraalVM's
`native-image-agent` — regenerate it rather than editing it by hand. See
[CLAUDE.md](CLAUDE.md) for the details that will bite you.
